        ...
        <div class="row">
            <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
                <div class="feature-1">
                    ...
                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Voluptas ullam, cumque a
                        debitis reiciendis dolorum ad minus error.</p>
                </div>
            </div>
            <div class="col-md-6 col-lg-4 mb-4 mb-lg-0">
                <div class="feature-1">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-5">
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sapiente reprehenderit aspernatur,
                    reiciendis explicabo doloribus aperiam sed sequi, aut repudiandae magni nobis
                    voluptatem!</p>
                <div class="d-flex align-items-center">
                    <span class="sign mr-4">
                        <img src="{{ asset('images/signature.svg') }}" alt="" class="img-fluid">
                    </span>
                    <div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-6 col-lg-4 mb-5">
                <div class="d-flex align-items-center justify-content-center counter">
                    <span class="icon-building-o wrap-icon mx-4"></span>
                    <div class="text">
            ...
            <div class="col-md-6 col-lg-4 mb-5">
                <div class="d-flex align-items-center justify-content-center counter">
                    <span class="icon-home2 wrap-icon mx-3"></span>
                    <div class="text">
        ...
        <div class="row">
            <div class="col-12">
                <div class="nonloop-block-13 owl-carousel">
                    <div class="news-1" style="background-image: url('{{ asset('images/img_1.jpg') }}');">
                        <div class="text">
                    ...
                    <div class="news-1" style="background-image: url('{{ asset('images/img_2.jpg') }}');">
                        <div class="text">
                            <h3><a href="#">Consectetur adipisicing elit</a></h3>
                            <span class="category d-block mb-3">Web Development</span>
                            <p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
                    ...
                    <div class="news-1" style="background-image: url('{{ asset('images/img_3.jpg') }}');">
                        <div class="text">
                            <h3><a href="#">Consectetur adipisicing elit</a></h3>
                            <span class="category d-block mb-3">Web Development</span>
                            <p class="mb-4">Lorem ipsum dolor sit amet, consectetur adipisicing elit.</p>
    ...
    <div class="container">
        <div class="row justify-content-center text-center">
            <div class="col-12 col-lg-7 text-center mb-5">
                ...
                <p class="lead text-white">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Laboriosam
                    quo doloribus, suscipit libero, voluptate aliquam.</p>
            </div>
        </div>
        <div class="row">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-4 mb-4 mb-lg-0">
                <div class="testimonial-2 text-center">
                    <div class="v-card mb-4 text-center">
                        <img src="{{ asset('images/person_1.jpg') }}" alt="Image" class="img-fluid mx-auto d-block">
            ...
            <div class="col-lg-4 mb-4 mb-lg-0">
                <div class="testimonial-2 text-center">
                    <div class="v-card mb-4 text-center">
                        <img src="{{ asset('images/person_2.jpg') }}" alt="Image" class="img-fluid mx-auto d-block">
            ...
            <div class="col-lg-4 mb-4 mb-lg-0">
                <div class="testimonial-2 text-center">
                    <div class="v-card mb-4 text-center">
                        <img src="{{ asset('images/person_3.jpg') }}" alt="Image" class="img-fluid mx-auto d-block">
